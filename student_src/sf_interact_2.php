<?php
    ...
    if(isset($_POST['interact']))
    {
        ...
        $_SESSION['s_interact_faculty_id'] = $value[1];
        $_SESSION['s_interact_course_name'] = $value[2];
        $_SESSION['s_interact_faculty_name'] = $value[3];
    }
...
<body style="background-color: rgb(255, 255, 128);">
    <div class="container-fluid pt-1">
        <div class="card">
            <div class="card-header p-3" style="text-align:center;display:inline;">
                <h1 style="font-family: Amita;"><b><i>Student Faculty Interaction</i></b></h1>
            ...
            <div class="card-body row">
                <div class="col-sm-3 list-group">
                    ...
                    <a href="sf_interact.php" class="list-group-item list-group-item-action active">Interact with Faclty</a>                        
                ...
                <div class="col-sm-9">
                    ...
                    <ul class="d-flex justify-content-center row list-group list-group-horizontal" style="text-align: center;margin:auto;">
                        <li class="col-sm-4 list-group-item"><b>Faculty Name : </b><?php if(isset($_SESSION['s_interact_faculty_name'])){echo $_SESSION['s_interact_faculty_name'];} ?></li>
                    ...
                    <br>
                    <form action="sf_interact_3.php" method="post" onsubmit="return filesize_validate()" enctype="multipart/form-data">
    ...
    <?php
        ...
        $query3 = $conn->prepare("SELECT * FROM `sf_interact` WHERE `course_id` = ? ORDER BY `time_stamp`");
