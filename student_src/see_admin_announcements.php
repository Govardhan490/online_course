        ...
        <div class="card">
            ...
            <div class="card-body row">
                ...
                <a href="view_registered_course.php" class="list-group-item list-group-item-action" style="color: black;">View Registered Courses</a>
                    ...
                    <a href="see_admin_announcements.php" class="list-group-item list-group-item-action active">View Admin Announcement</a>
    ...
    <?php
        ...
        if($query->execute())
        {
            ...
            {    
                ...
                echo "\n});</script>";
                $query2 = $conn->prepare("SELECT * FROM `admin_announcement` WHERE `course_id` IN (SELECT `course_id` FROM `registered` WHERE `usn`=?) ORDER BY `time_Stamp` DESC");
