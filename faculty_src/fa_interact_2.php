<?php
    ...
    if(isset($_POST['interact']))
    {
        ...
        $_SESSION['f_interact_admin_id'] = $value[1];
        $_SESSION['f_interact_course_name'] = $value[2];
        $_SESSION['f_interact_admin_name'] = $value[3];
    }
...
<body style="background-color: rgb(255, 255, 128);">
        ...
        <div class="card">
            ...
            <div class="card-body row">
                ...
                <div class="col-sm-9">
                    ...
                    <ul class="d-flex justify-content-center row list-group list-group-horizontal" style="text-align: center;margin:auto;">
                        <li class="col-sm-4 list-group-item"><b>Admin Name : </b><?php if(isset($_SESSION['f_interact_admin_name'])){echo $_SESSION['f_interact_admin_name'];} ?></li>
                    ...
                    <br>
                    <form action="fa_interact_3.php" method="post" onsubmit="return filesize_validate()" enctype="multipart/form-data">
    ...
    <?php
        ...
        $query3->bind_param("s",$_SESSION['f_interact_course_id']);
        if($query3->execute())
        {
