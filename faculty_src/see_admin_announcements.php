...
<head>
    ...
    <title>View Admin Announcements</title>
    ...
    <div class="container-fluid pt-1">
        <div class="card">
            <div class="card-header p-3" style="text-align:center;display:inline;">
                <h1 style="font-family: Amita;"><b><i>View Admin Announcements</i></b></h1>
            ...
            <div class="card-body row">
                <div class="col-sm-3 list-group">
                    ...
                    <a href="see_admin_announcements.php" class="list-group-item list-group-item-action active">See Admin Announcement</a>
    ...
    <?php
        ...
        if($query->execute())
        {
            ...
            {    
                ...
                echo "\n});</script>";
                $query2 = $conn->prepare("SELECT * FROM `admin_announcement` WHERE `course_id` IN (SELECT `course_id` FROM `course` WHERE `faculty_id`=?) ORDER BY `time_Stamp` DESC");
